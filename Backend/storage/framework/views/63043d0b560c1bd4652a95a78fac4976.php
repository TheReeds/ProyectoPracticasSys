    ...
    <div class="container container-tight py-4">
        <div class="text-center mb-1 mt-5">
            <a href="" class="navbar-brand navbar-brand-autodark">
                <img src="<?php echo e(asset(config('tablar.auth_logo.img.path','assets/logo.svg'))); ?>" height="36"
                     alt=""></a>
        </div>
...
<?php echo $__env->make('tablar::auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyecto\Practicas-app\resources\views/vendor/tablar/auth/login.blade.php ENDPATH**/ ?>
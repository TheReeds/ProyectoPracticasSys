                ...
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item">
                        ...
                        <a href="https://ebuz.xyz"
                           class="link-secondary"><?php echo e(config('tablar.bottom_title', 'TabLar')); ?></a>.
                        All rights reserved.
                    </li>
                    <li class="list-inline-item">
                        <a href="https://ebuz.xyz" class="link-secondary" rel="noopener">
                            <?php echo e(config('tablar.current_version', '1.0')); ?>
...
<?php /**PATH D:\Proyecto\Practicas-app\resources\views/vendor/tablar/partials/footer/bottom.blade.php ENDPATH**/ ?>